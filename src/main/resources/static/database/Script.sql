...
INSERT INTO SALESMAN_t VALUES(DEFAULT, 'Dohn', 'Joe', '5678', 'joe.dohn@gmail.com');
INSERT INTO MEMBERSHIP_t VALUES(DEFAULT, 'Silver', '30', 1000);
...
INSERT INTO ITEM_t VALUES(DEFAULT, 'PETIT SAC À MAIN OPHIDIA GG', 1509.99, 100, (SELECT idBrand FROM BRAND_t WHERE nameBrand='Guccii'));
INSERT INTO ITEM_t VALUES(DEFAULT, 'VALISE À ROULETTES GUCCI SAVOY GG TAILLE M', 2799.99, 200, (SELECT idBrand FROM BRAND_t WHERE nameBrand='Guccii'));
